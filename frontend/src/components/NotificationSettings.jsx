    ...
    <div className="bg-gray-800 rounded-lg p-6 border border-gray-700">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Get desktop notifications for completed sessions
            </p>
          </div>
          ...
          <div className="ml-4">
            ...
            <input
              ...
              style={{
                ...
                }%, #4B5563 ${preferences.volume * 100}%, #4B5563 100%)`,
              }}
            />
          </div>
        )}
        ...
        <div className="text-xs text-gray-400 bg-gray-700 p-3 rounded-lg">
          <strong>💡 Tip:</strong> Browser notifications require permission and
          work best when this tab is not focused. Sound effects work in all
          browsers and don't require special permissions.
        </div>
      </div>
    </div>
  )
